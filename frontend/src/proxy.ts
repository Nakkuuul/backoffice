 ...
 * /bff/auth/me (which refreshes or 401s). The matcher excludes the public auth
 * pages (/login, /forgot-password, /reset-password), the BFF route handlers, and
 * static assets.
 */
...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon.ico|login|forgot-password|reset-password|bff/).*)"],
};
